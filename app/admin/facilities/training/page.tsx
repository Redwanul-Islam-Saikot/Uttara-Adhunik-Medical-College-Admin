  ...
  return (
    <div className="lg:ml-72 p-6 space-y-6">
      <div className="flex justify-between items-center bg-white p-6 rounded-xl border shadow-sm">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Training Facilities Management</h1>
          <p className="text-sm text-gray-500 mt-1">Manage training facility content and updates</p>
        </div>
        <button
        ...
        >
          <Edit3 size={16} /> Edit Training Content
        </button>
      </div>
